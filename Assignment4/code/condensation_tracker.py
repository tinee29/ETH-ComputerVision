...
def condensation_tracker(video_name, params):
    ...
    '''
    # Choose video
    if video_name == "video1.avi" or video_name == "video1.wmv":
        first_frame = 10
        last_frame = 42
    elif video_name == "video2.avi" or video_name == "video2.wmv":
        first_frame = 3
        last_frame = 40
    elif video_name == "video3.avi" or video_name == "video3.wmv":
        first_frame = 1
        last_frame = 60
